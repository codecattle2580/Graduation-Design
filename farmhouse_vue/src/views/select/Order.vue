    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-table :data="list" @selection-change="selschange" border style="width: 100%">
                ...
                <el-table-column prop="dbooktime" :formatter="formatDateTime" label="下单时间" align="center"></el-table-column>
                <el-table-column prop="djoin" :formatter="formatDateTime" label="入住时间" align="center"></el-table-column>
                <el-table-column prop="dleave" :formatter="formatDateTime" label="退房时间" align="center"></el-table-column>
                <el-table-column prop="dstate" label="订单状态"></el-table-column>
                ...
                <div class="data-container">
                    <el-form :model="form" :rules="formRules" ref="FormRef" label-width="120px">
                        <el-form-item label="美食评分" prop="foodgrade">
                            <el-rate v-model="form.foodgrade"></el-rate>
                        </el-form-item>
                        <el-form-item label="客房评分" prop="roomgrade">
                            <el-rate v-model="form.roomgrade"></el-rate>
                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            // console.log(params);
            const { data: res } = await this.$http.get('/order/getusername', { params })
            this.list = res.rows
