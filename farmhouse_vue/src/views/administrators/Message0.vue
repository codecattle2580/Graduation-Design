    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-table :data="list" @selection-change="selschange" border style="width: 100%;">
                ...
                <el-table-column prop="messagetime" :formatter="formatDateTime" label="留言时间"></el-table-column>
                <el-table-column prop="foodgrade" label="食物评分"></el-table-column>
                <el-table-column prop="roomgrade" label="客房评分"></el-table-column>
                <el-table-column prop="nname" label="农家乐名称"></el-table-column>
                <el-table-column prop="zname" label="客房名称"></el-table-column>
                <el-table-column prop="ztype" label="客房类型"></el-table-column>
                <el-table-column prop="zprice" label="客房价格"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            // console.log(params);
            const { data: res } = await this.$http.get('/message', { params })
            this.list = res.rows
