    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-table :data="list" @selection-change="selschange" border style="width: 100%">
                ...
                <el-table-column type="index" label="序号" align="center" fixed :min-width="25"></el-table-column>
                ...
                <el-table-column prop="dbooktime" :formatter="formatDateTime" label="下单时间" align="center" width="150"></el-table-column>
                <el-table-column prop="djoin" :formatter="formatDateTime" label="入住时间" align="center" width="150"></el-table-column>
                <el-table-column prop="dleave" :formatter="formatDateTime" label="退房时间" align="center" width="150"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            console.log(params);
            const { data: res } = await this.$http.get('/order/merchant', { params })
            this.list = res.rows
